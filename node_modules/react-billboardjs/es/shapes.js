...
export var LABEL_SHAPE = PropTypes.oneOfType([PropTypes.shape({
  position: PropTypes.oneOf(['inner-bottom', 'inner-center', 'inner-left', 'inner-right', 'inner-top', 'outer-bottom', 'outer-center', 'outer-left', 'outer-right', 'outer-top']),
...
export var DATA_SHAPE = PropTypes.shape({
  ...
  type: PropTypes.oneOf(['area', 'area-spline', 'area-step', 'bar', 'donut', 'gauge', 'line', 'pie', 'scatter', 'spline']),
